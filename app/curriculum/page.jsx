        ...
        >
          ...
          <div className="flex flex-wrap items-center justify-end gap-4">
            <ul className="flex flex-wrap items-center gap-3 text-sm sm:gap-5 sm:text-base">
              <li>
                <Link href="/" className="font-semibold text-[#0F172A] transition-colors duration-200 hover:text-[#2563EB]">
                  Home
                </Link>
              </li>
              <li>
                <Link href="/curriculum" className="font-semibold text-[#2563EB]">
                  Curriculum
                </Link>
              </li>
              <li>
                <Link href="/testimonials" className="font-semibold text-[#0F172A] transition-colors duration-200 hover:text-[#2563EB]">
                  Testimonials
                </Link>
              </li>
              <li>
                <Link href="/practice" className="font-semibold text-[#0F172A] transition-colors duration-200 hover:text-[#2563EB]">
                  Practice
                </Link>
              </li>
            </ul>
