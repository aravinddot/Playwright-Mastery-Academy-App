...
function PlacementLogoTile({ logo }) {
  ...
  return (
    <div className="flex h-20 w-[190px] shrink-0 items-center justify-center rounded-xl border border-[#E2E8F0] bg-white/95 px-4 shadow-[0_12px_28px_-24px_rgba(11,42,74,0.4)]">
      <img
        src={logo.src}
        alt={`${logo.name} logo`}
        loading="lazy"
...
function TestimonialCard({ item, delay = 0 }) {
  ...
  return (
    <motion.article
      {...withDelay(delay)}
      className="flex h-full flex-col rounded-xl border border-[#E2E8F0] bg-white p-5 shadow-[0_14px_34px_-24px_rgba(11,42,74,0.35)] transition-[transform,box-shadow,border-color] duration-200 md:hover:-translate-y-0.5 md:hover:border-[#2563EB] md:hover:shadow-[0_18px_40px_-24px_rgba(37,99,235,0.28)]"
    >
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_12%_9%,rgba(37,99,235,0.08),transparent_36%),radial-gradient(circle_at_88%_26%,rgba(59,130,246,0.07),transparent_34%),#F8FAFC] text-[#0F172A]">
      ...
      <main className="mx-auto w-full max-w-6xl px-6 py-10 lg:px-8 lg:py-12">
        <motion.section
          {...revealProps}
          className="mb-8 rounded-xl border border-[#E2E8F0] bg-white p-6 shadow-[0_14px_34px_-24px_rgba(11,42,74,0.35)] sm:p-8"
        >
        ...
        <motion.section
          {...revealProps}
          className="rounded-xl border border-[#E2E8F0] bg-white p-6 shadow-[0_14px_34px_-24px_rgba(11,42,74,0.35)] sm:p-8"
        >
